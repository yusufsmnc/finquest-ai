...
class AppColors {
  ...
  static Color cyanGlow(double opacity) => cyan.withValues(alpha: opacity);
  static Color purpleGlow(double opacity) => purple.withValues(alpha: opacity);
  ...
  static Color errorGlow(double opacity) => error.withValues(alpha: opacity);
